...
- **Performance** :
  - The below chart comes from an September 2020 study (https://www.mdpi.com/2220-9964/9/10/563). The purpose of this study was to compare OpenLayers to Mapbox-GL-JS and Leaflet (both raster and vector tile variants) as the potential basis for a Life Quality Index for 55,000+ census radius jurisdictions in Argentina.
    ![Execution Time](./0002-files/ExecutionTime.png) (Source (https://www.mdpi.com/2220-9964/9/10/563))
...
- **Data Usage** : The same study above also analyzed the amount of data usage for each of the libraries under investigation, and the result was the below chart (Lower values are better). OpenLayers overall performed quite well
  ![Data Usage](./0002-files/NetworkTraffic.png) (source (https://www.mdpi.com/2220-9964/9/10/563))
