...
export const DOWNLOAD_ZIP_URL =
  "https://justice40-data.s3.amazonaws.com/data-pipeline/data/score/downloadable/Screening+Tool+Data.zip";

// Todo VS: update URL with new AWS S3 directory structure
// This S3 and CDN are for dev only. Will need to update to prod when it's ready.
// Will want to use dev for local dev.
// Have a URL parameter to change be_env=dev vs be_env=prod to switch environments

// https://justice40-data.s3.amazonaws.com/data-pipeline/data/score/tiles/high/
// https://justice40-data.s3.amazonaws.com/data-pipeline/data/score/tiles/low/
...
export const CURRENTLY_SELECTED_FEATURE_HIGHLIGHT_LAYER_NAME =
  "currently-selected-feature-highlight-layer";
export const BLOCK_GROUP_BOUNDARY_LAYER_NAME = "block-group-boundary-layer";

// Properties
export const POVERTY_PROPERTY_PERCENTILE =
  "Poverty (Less than 200% of federal poverty line) (percentile)";
export const HOUSING_BURDEN_PROPERTY_PERCENTILE =
  "Housing burden (percent) (percentile)";
export const LINGUISTIC_ISOLATION_PROPERTY_PERCENTILE =
  "Linguistic isolation (percent) (percentile)";
export const UNEMPLOYMENT_PROPERTY_PERCENTILE =
