...
// REFERENCE: [ https://groups.google.com/g/justice40-open-source/c/kbmnIvsmnv0/m/B_wHXJj5AgAJ?utm_medium=email&utm_source=footer ]
...
const AreaDetail = ({ properties, hash }: IAreaDetailProps) => {
  ...
  const pct_aa = properties[constants.PERCENT_AFRICAN_AMERICAN] ? properties[constants.PERCENT_AFRICAN_AMERICAN] : "N/A";
    ...
    <aside className={styles.areaDetailContainer} data-cy={'aside'}>
      ...
      <ul className={styles.censusRow}>
        ...
        <li>
          ...
          <span className={styles.censusText}>{` ${pct_aa.toLocaleString()}`}</span>
        </li>
      </ul>
