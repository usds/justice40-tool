...
- Tome nota del `id` en este archivo y vuelva a agregarlo como un parámetro de su función/accesorio para su componente (esto se hace para evitar colisiones de nombres como se detalla [aquí](https://formatjs.io/docs/getting-started/message-extraction/)
