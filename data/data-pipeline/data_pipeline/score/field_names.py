...
HOUSING_BURDEN_LOW_INCOME = (
    "At or above the 90th percentile for housing cost burden and is low income"
)
...
# Health Burden
DIABETES_LOW_INCOME = (
    "At or above the 90th percentile for diabetes and is low income"
)
ASTHMA_LOW_INCOME = (
...
LIFE_EXPECTANCY_INCOME = (
    "At or above the 90th percentile for life expectancy and is low income"
)
# Workforce
UNEMPLOYMENT_LOW_HS_EDUCATION = """At or above the 90th percentile"
    for unemployment and where the high school degree achievement rate
    for adults 25 years and older is less than 90%"""
LINGUISTIC_ISOLATION_LOW_HS_EDUCATION = """At or above the 90th percentile
    for linguistic isolation and where the high school degree achievement rate
    for adults 25 years and older is less than 90%"""
POVERTY_LOW_HS_EDUCATION  = """At or above the 90th percentile for households
...
MEDIAN_INCOME_LOW_HS_EDUCATION = """At or below the 90th percentile for median
