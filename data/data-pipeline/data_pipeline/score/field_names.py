...
BLACK_FIELD_NAME = "Black or African American"
AMERICAN_INDIAN_FIELD_NAME = "American Indian / Alaska Native"
...
OTHER_RACE_FIELD_NAME = "Other Races"

# Same fields, but with a percent prefix
PERCENT_PREFIX = "Percent "

PERCENT_BLACK_FIELD_NAME = PERCENT_PREFIX + BLACK_FIELD_NAME
PERCENT_AMERICAN_INDIAN_FIELD_NAME = PERCENT_PREFIX + AMERICAN_INDIAN_FIELD_NAME
PERCENT_ASIAN_FIELD_NAME = PERCENT_PREFIX + ASIAN_FIELD_NAME
PERCENT_HAWAIIAN_FIELD_NAME = PERCENT_PREFIX + HAWAIIAN_FIELD_NAME
PERCENT_TWO_OR_MORE_RACES_FIELD_NAME = (
    PERCENT_PREFIX + TWO_OR_MORE_RACES_FIELD_NAME
)
PERCENT_NON_HISPANIC_WHITE_FIELD_NAME = (
    PERCENT_PREFIX + NON_HISPANIC_WHITE_FIELD_NAME
)
PERCENT_HISPANIC_FIELD_NAME = PERCENT_PREFIX + HISPANIC_FIELD_NAME
PERCENT_OTHER_RACE_FIELD_NAME = PERCENT_PREFIX + OTHER_RACE_FIELD_NAME
