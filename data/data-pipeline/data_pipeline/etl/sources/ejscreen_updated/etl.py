...
class EJSCREENUpdatedETL(ExtractTransformLoad):
    ...
    def __init__(self):
        ...
        self.RENAME_DICTIONARY = {
            "GEOID_TRACT_10": self.GEOID_TRACT_FIELD_NAME,
            "ACSTOTPOP_WEIGHTED": field_names.TOTAL_POP_FIELD,
            "CANCER_WEIGHTED": field_names.AIR_TOXICS_CANCER_RISK_FIELD,
            "RESP_WEIGHTED": field_names.RESPIRATORY_HAZARD_FIELD,
            "DSLPM_WEIGHTED": field_names.DIESEL_FIELD,
            "PM25_WEIGHTED": field_names.PM25_FIELD,
            "OZONE_WEIGHTED": field_names.OZONE_FIELD,
            "PTRAF_WEIGHTED": field_names.TRAFFIC_FIELD,
            "PRMP_WEIGHTED": field_names.RMP_FIELD,
            "PTSDF_WEIGHTED": field_names.TSDF_FIELD,
            "PNPL_WEIGHTED": field_names.NPL_FIELD,
            "PWDIS_WEIGHTED": field_names.WASTEWATER_FIELD,
            "LINGISOPCT_WEIGHTED": field_names.HOUSEHOLDS_LINGUISTIC_ISO_FIELD,
            "LOWINCPCT_WEIGHTED": field_names.POVERTY_FIELD,
            "OVER64PCT_WEIGHTED": field_names.OVER_64_FIELD,
            "UNDER5PCT_WEIGHTED": field_names.UNDER_5_FIELD,
            "PRE1960PCT_WEIGHTED": field_names.LEAD_PAINT_FIELD,
        }
