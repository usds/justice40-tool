...
class CensusACSETL(ExtractTransformLoad):
    ...
    def get_data_sources(self) -> [DataSource]:
        ...
        return [CensusDataSource(name=self.__class__.__name__, source=None, destination=self.census_acs_source, acs_year=self.ACS_YEAR, variables=variables, tract_output_field_name=self.GEOID_TRACT_FIELD_NAME, data_path_for_fips_codes=self.DATA_PATH, acs_type="acs5")]
