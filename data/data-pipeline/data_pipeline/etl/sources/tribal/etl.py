...
class TribalETL(ExtractTransformLoad):
    ...
    def get_data_sources(self) -> [DataSource]:
        ...
        national_lar_url = settings.AWS_JUSTICE40_DATASOURCES_URL + "/BIA_National_LAR_updated_20220929.zip"
        tsa_and_aian_url = settings.AWS_JUSTICE40_DATASOURCES_URL + "/BIA_TSA_and_AIAN_json.zip"
    ...
    def transform(self) -> None:
        ...
        """
        # Set the filepaths:
        bia_national_lar_shapefile = self.get_sources_path() / "bia_national_lar"

        bia_aian_supplemental_geojson = self.get_sources_path() / "tsa_and_aian" / "BIA_AIAN_Supplemental.json"

        bia_tsa_geojson = self.get_sources_path() / "tsa_and_aian" / "BIA_TSA.json"

        alaska_native_villages_geojson = self.get_sources_path() / "alaska_native_villages" / "AlaskaNativeVillages.gdb.geojson"
    ...
    def load(self) -> None:
        ...
        usa_tribal_df.to_file(self.NATIONAL_TRIBAL_GEOJSON_PATH, driver="GeoJSON")
