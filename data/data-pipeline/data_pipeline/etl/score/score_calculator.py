...
class ScoreCalculator():
    ...
    def transportation_factor(self) -> bool:
        # In Xth percentile or above for diesel particulate matter (Source: EPA National Air
        # Toxics Assessment (NATA)
        # or
        # In Xth percentile or above for PM 2.5 (Source: EPA, Office of Air and Radiation
        # (OAR) fusion of model and monitor data)]
        # or
        # In Xth percentile or above traffic proximity and volume (Source: 2017 U.S.
        # Department of Transportation (DOT) traffic data
        # AND
        # Low income: In 60th percentile or above for percent of block group population
        # of households where household income is less than or equal to twice the federal
        # poverty level. Source: Census's American Community Survey]
        transportation_criteria = (self.df[self.DIESEL_FIELD] > 0.90) | (
    ...
    def housing_factor(self) -> bool:
        # In Xth percentile or above for lead paint (Source: Census's American
        # Community Survey’s percent of housing units built pre-1960, used as an
        # indicator of potential lead paint exposure in homes)
        # or
        # In Xth percentile or above for housing cost burden (Source: HUD's
        # Comprehensive Housing Affordability Strategy dataset
        # AND
        # Low income: In 60th percentile or above for percent of block group population
        # of households where household income is less than or equal to twice the federal
        # poverty level. Source: Census's American Community Survey]
        housing_criteria = (self.df[self.LEAD_PAINT_FIELD] > 0.40) | (
    ...
    def water_factor(self) -> bool:
        # In Xth percentile or above for wastewater discharge (Source: EPA
    ...
    def health_factor(self) -> bool:
        ...
        health_criteria = (
            ...
            | (
                self.df[self.LIFE_EXPECTANCY_FIELD] < 0.10
            )  # A HIGH NUMBER HERE IS GOOD
        )
        return (
            self.df[self.POVERTY_LESS_THAN_200_FPL_FIELD]
            > self.LOW_INCOME_THRESHOLD
    ...
    def workforce_factor(self) -> bool:
        ...
        # or
        # Where the percent of households at or below 100% of the federal
        # poverty level is greater than Z%
        # or
        # Where linguistic isolation is greater than Y%
        # AND
        # Where the high school degree achievement rates for adults 25 years
        # and older is less than 95%
