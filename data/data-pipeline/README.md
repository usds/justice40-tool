...
If you want to use the shapefiles in mapping applications, you [can download them here](https://justice40-data.s3.amazonaws.com/data-pipeline/data/score/shapefile/).
