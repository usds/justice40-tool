...
def validate_all_data_set_descriptions(data_set_description_schema: yamale.schema.schema.Schema):
...
def write_data_set_description_template_file(
    ...
    template_file_lines.append("# This template is automatically generated by the function `write_data_set_description_template_file`. ")
